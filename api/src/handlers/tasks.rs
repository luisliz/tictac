...
pub async fn get_tasks(db: web::Data<Pool>, user_id: web::Path<i32>) -> impl Responder {
...
pub async fn get_task(db: web::Data<Pool>, task_id: web::Path<i32>, user_id: web::Path<i32>) -> impl Responder {
    let connection = db.get().unwrap();
...
pub async fn create_task(db: web::Data<Pool>, task: web::Json<Task>, user_id: web::Path<i32>) -> impl Responder {
    let connection = db.get().unwrap();
...
pub async fn update_task(db: web::Data<Pool>, task_id: web::Path<i32>, task: web::Json<Task>, user_id: web::Path<i32>) -> impl Responder {
...
pub async fn delete_task(db: web::Data<Pool>, task_id: web::Path<i32>, user_id: web::Path<i32>) -> impl Responder {
    let mut connection = db.get().unwrap();
